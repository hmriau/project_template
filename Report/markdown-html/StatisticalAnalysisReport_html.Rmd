...
The Hmis library has several useful fuinctions for reading and anotating
...
Unofrtunately, as far as I can tell there is no nice way to display the
regression table in HTML. This oucld be done manually
